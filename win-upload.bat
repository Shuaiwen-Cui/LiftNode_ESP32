...
@REM git push -f https://github.com/Shuaiwen-Cui/LiftNode_ESP32.git main
git push -f https://github.com/Shuaiwen-Cui/LiftNode_ESP32.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/LiftNode_ESP32.git
